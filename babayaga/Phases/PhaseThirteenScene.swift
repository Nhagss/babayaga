...
class PhaseThirteenScene: GameSceneBase {
    let ingredientesDisponiveis = [
        Ingredient(id: 1, name: "Olho de tritão", total: 4),
        Ingredient(id: 2, name: "Pó de fada", total: 4),
    ...
    override func setupPlanets() {
        ...
        planet8.view.position = CGPoint(x: -150, y: 2100)
        
        /// Adiciona planetas à lista
        planetControllers = [planet1, planet2, planet3, planet4, planet5, planet6, planet7, planet8]
        ...
        planetControllers[2].view.addIngredient(model: ingredientesDisponiveis[0], angleInDegrees: 300, onCollect: onCollect)
        ...
        planetControllers[4].view.addIngredient(model: ingredientesDisponiveis[0], angleInDegrees: 350, onCollect: onCollect)
        ...
        planetControllers[6].view.addIngredient(model: ingredientesDisponiveis[0], angleInDegrees: 350, onCollect: onCollect)
        planetControllers[7].view.addIngredient(model: ingredientesDisponiveis[1], angleInDegrees: 180, onCollect: onCollect)

...
class PhaseTwelveScene: GameSceneBase {
    ...
    override func setupPlanets() {
        ...
        planetControllers[2].view.addIngredient(model: ingredientesDisponiveis[2], angleInDegrees: 180, onCollect: onCollect)
        planetControllers[3].view.addIngredient(model: ingredientesDisponiveis[0], angleInDegrees: 300, onCollect: onCollect)
        planetControllers[4].view.addIngredient(model: ingredientesDisponiveis[2], angleInDegrees: 300, onCollect: onCollect)
...
//        planetControllers[3].addEnemySpike(angleInDegrees: 180)
       ...
       planetControllers[3].addMultipleEnemyBat(angleInDegrees: 90, delayApparitions: 3, rotationTimes: 1, numberOfEnemyBat: 2, rotationDirection: .counterClockwise)
        planetControllers[5].addMultipleEnemyBat(angleInDegrees: 0, delayApparitions: 3, rotationTimes: 1, numberOfEnemyBat: 1, rotationDirection: .counterClockwise)

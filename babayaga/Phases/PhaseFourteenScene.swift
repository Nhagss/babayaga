...
class PhaseFourteenScene: GameSceneBase {
    let ingredientesDisponiveis = [
        Ingredient(id: 1, name: "Olho de tritão", total: 5), //tinha 4
        Ingredient(id: 2, name: "Pó de fada", total: 5),
        Ingredient(id: 3, name: "Asa de morcego", total: 5)
    ]
    ...
    override func setupPlanets() {
        ...
        planetControllers = [planet1, planet2, planet3, planet4, planet5, planet6, planet7, planet8, planet9, planet10]
        ...
        planetControllers[2].view.addIngredient(model: ingredientesDisponiveis[2], angleInDegrees: 225, onCollect: onCollect)
        planetControllers[3].view.addIngredient(model: ingredientesDisponiveis[0], angleInDegrees: 225, onCollect: onCollect)
        ...
        planetControllers[5].view.addIngredient(model: ingredientesDisponiveis[0], angleInDegrees: 225, onCollect: onCollect)
        ...
        planetControllers[7].view.addIngredient(model: ingredientesDisponiveis[0], angleInDegrees: 180, onCollect: onCollect)
        planetControllers[7].view.addIngredient(model: ingredientesDisponiveis[1], angleInDegrees: 225, onCollect: onCollect)
        planetControllers[8].view.addIngredient(model: ingredientesDisponiveis[2], angleInDegrees: 360, onCollect: onCollect)
        planetControllers[8].view.addIngredient(model: ingredientesDisponiveis[0], angleInDegrees: 180, onCollect: onCollect)
        planetControllers[9].view.addIngredient(model: ingredientesDisponiveis[1], angleInDegrees: 225, onCollect: onCollect)
        planetControllers[9].view.addIngredient(model: ingredientesDisponiveis[2], angleInDegrees: 180, onCollect: onCollect)
...
//        planetControllers[4].addEnemySpike(angleInDegrees: 150)
       ...
       planetControllers[4].addMultipleEnemyBat(angleInDegrees: 90, delayApparitions: 3, rotationTimes: 1, numberOfEnemyBat: 1, rotationDirection: .counterClockwise)
        planetControllers[7].addMultipleEnemyBat(angleInDegrees: 90, delayApparitions: 3, rotationTimes: 1, numberOfEnemyBat: 2, rotationDirection: .counterClockwise)

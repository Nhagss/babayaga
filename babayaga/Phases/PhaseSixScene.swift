...
class PhaseSixScene: GameSceneBase {
    ...
    override func setupPlanets() {
        ...
        planet2.view.position = CGPoint(x: -350, y: 100)
        planet3.view.position = CGPoint(x: -750, y: -100)
        planet4.view.position = CGPoint(x: -1050, y: 250)
        planet5.view.position = CGPoint(x: -850, y: 650)
        ...
        planetControllers[0].view.addIngredient(model: ingredientesDisponiveis[0], angleInDegrees: 380, onCollect: onCollect)
        planetControllers[1].view.addIngredient(model: ingredientesDisponiveis[2], angleInDegrees: 290, onCollect: onCollect)
        ...
        planetControllers[0].addEnemySpike(angleInDegrees: 315)
        planetControllers[1].addEnemySpike(angleInDegrees: 250)
        ...
        // Adiciona o morcego
        planetControllers[3].addMultipleEnemyBat(angleInDegrees: 280, delayApparitions: 3, rotationTimes: 1, numberOfEnemyBat: 1, rotationDirection: .counterClockwise)
    }
}
